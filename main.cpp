...
int main(int argc, char* argv[]) {
    ...
    if (rank == 0) {
        cout << "====================================\n";
        cout << "Butterfly Counting with PBFC-MPI-OPT\n";
        cout << "====================================\n";
    ...
    if (rank == 0) {
        ...
        for (const auto& eb : all_butterflies) {
            ...
            for (int r = 0; r < size; ++r) {
                if (eb.u < graph.num_u && find(local_graph.local_u.begin(), local_graph.local_u.end(), eb.u) != local_graph.local_u.end()) {
                    partition = rank;
                    break;
                }
            }
